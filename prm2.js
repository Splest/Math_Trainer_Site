...
let count=0;
let x1 = Math.round(rnd(2,21));
let x2 = Math.round(rnd(2,21));
...
x1 = Math.round(rnd(2,21));
x2 = Math.round(rnd(2,21));
str1.textContent = x1 + " * " + x2 + " = ?";
let ansr2 = x1*x2;
...
x1 = Math.round(rnd(1,21));
x2 = Math.round(rnd(1,21));
let ansr9 = x1;
str1.textContent = x1*x2 + " / " + x2 + " = ?";
